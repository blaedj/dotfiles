;;; custom-doom-tomorrow-night-theme.el -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

(defgroup custom-doom-tomorrow-night-theme nil
  "Options for the `custom-doom-tomorrow-night' theme."
  :group 'doom-themes)
...
(defcustom custom-doom-tomorrow-night-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'custom-doom-tomorrow-night-theme
  :type 'boolean)


(def-doom-theme custom-doom-tomorrow-night
  "A theme based off of doom's theme that is based off of Chris Kempson's Tomorrow Dark."
  ...
  ((bg         '("#1d1f21" nil       nil          ))
   ...
   (selection      `(,(car (doom-lighten bg 0.2)) ,@(cdr base4)))
   (builtin        blue)
   (comments       (if custom-doom-tomorrow-night-brighter-comments (doom-lighten grey 0.4) grey))
   (doc-comments   (doom-lighten grey 0.24))
   (constants      orange)
   (functions      blue)
   (keywords       violet)
   (methods        blue)
