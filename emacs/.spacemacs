...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(
                                      rvm ample-zen-theme smartscan rainbow-mode
                                          ag (vue-mode
                                              :location
                                              (recipe
                                               :fetcher github
