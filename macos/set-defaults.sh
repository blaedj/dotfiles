...
# sudo scutil --set ComputerName "gaspode"
# sudo scutil --set HostName "gaspode"
# sudo scutil --set LocalHostName "gaspode"
# sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "gaspode"
...
# Set a sorta fast keyboard repeat rate
...
# Display emails in threaded mode, sorted by date (not oldest at the top)
