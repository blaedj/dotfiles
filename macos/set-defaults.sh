...
# sudo scutil --set ComputerName "dibbler"
# sudo scutil --set HostName "dibbler"
# sudo scutil --set LocalHostName "dibbler"
# sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "dibbler"
